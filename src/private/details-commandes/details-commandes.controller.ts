...
export class DetailsCommandesController {
  constructor(private readonly detailsCommandesService: DetailsCommandesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDetailsCommandeDto: UpdateDetailsCommandeDto) {
